...
export function extractPassiveTime(instructions?: string[]): number {
  ...
  const passivePatterns = [
    ...
    // Handle "rest/sit...for X hours" with intervening text (e.g., "let the cheesecake sit in the oven...for 1 hour")
    ...
    // Handle "refrigerate/chill...for X hours" with intervening text (e.g., "refrigerate the cheesecake for at least 4 hours")
